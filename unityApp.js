const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/escape-tsunami-brainrot-v1.2[2]-mirraSDK[5.0.18].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/escape-tsunami-brainrot-v1.2[2]-mirraSDK[5.0.18].data",
            frameworkUrl: buildUrl + "/escape-tsunami-brainrot-v1.2[2]-mirraSDK[5.0.18].framework.js",
            codeUrl: buildUrl + "/escape-tsunami-brainrot-v1.2[2]-mirraSDK[5.0.18].wasm",
